...
# Aggressive keywords - IMPROVED: Reduced false positives
AGGRESSIVE_KEYWORDS = {
    'haste', 'first strike', 'double strike', 'menace', 'aggressive',
    'combat damage', 'unblockable', 'trample', 'vigilance',  # More specific
    'rush', 'charge', 'attacks each combat', 'must attack'
    # Removed generic 'damage' and 'attack' which caused false positives
}

# Control keywords - IMPROVED: More specific terms
CONTROL_KEYWORDS = {
    'counterspell', 'counter target', 'destroy target', 'exile target', 
    'board wipe', 'permission', 'card advantage', 'removal',
    'flying', 'vigilance', 'lifelink', 'protection',
    'draw cards', 'scry', 'instant', 'sorcery'
    # Removed generic 'control' and 'counter' which were too broad
}
